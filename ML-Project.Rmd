...
The accuracy is better in Random Forest method with `r confRpart$overall[1]`, so the out of sample error rate is 0.007. Therefore Random Forest method is chosen for the prediction.
